  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950/80 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-20 flex-col gap-4 py-4 md:flex-row md:items-center md:justify-between md:gap-4 md:py-4">
          ...
          <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center md:justify-end">
            ...
            <div className="relative w-full max-w-md">
              ...
              <input
                ...
                placeholder="Search commands, keys, or sources (e.g. 'NERDTree', 'Native', 'save')..."
                value={searchQuery}
