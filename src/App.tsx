...
// Use a type definition that matches our data
  ...
  return (
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200 selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        {filteredCommands.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <button 
                ...
                className="mt-6 text-sm text-emerald-400 hover:text-emerald-300 hover:underline"
            >
                Clear all filters
            </button>
          </div>
      ...
      <footer className="relative z-10 mt-auto border-t border-slate-900 py-8 text-center text-sm text-slate-600">
        <p>Built with React, Vite & Tailwind CSS 4.0</p>
      </footer>
    </div>
  );
}
